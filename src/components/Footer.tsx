    ...
    <>
      ...
      <footer className="relative max-container padding-container py-20  flex flex-col gap-12 lg:gap-20 bg-[#111111] text-white">
        <div className="flex flex-col gap-10 lg:flex-row lg:justify-between px-5 sm:px-[300px]">
          ...
          />
          <FooterCard
            link1="russia@silkroaddestinations.com"
            link2="+998 91 524 79 25"
          />
          <div className="flex flex-col gap-4">
            <ul
              role="list"
          ...
          */}
              <li className="t-sociallinks__item t-sociallinks__item_facebook">
                <a
                  href="https://www.linkedin.com/in/ravshan-turakulov-03393620?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"
                  target="_blank"
                  rel="nofollow noopener"
                  aria-label="Linkedin"
                  title="Linkedin"
