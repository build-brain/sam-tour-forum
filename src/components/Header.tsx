...
export function MainNav({
  ...
  return (
    <>
      <header className="fixed top-0  bg-white w-full  flex items-center justify-between  px-0 sm:px-10 z-[50]">
        <Link href="/">
          <div className="flex items-center gap-5">
            <Image width={230} height={88} src="/logo.png" alt="logo" />
          </div>
        </Link>
        ...
        <Sheet>
          <SheetTrigger asChild>
            <button
              className="lg:hidden flex items-center me-4  focus:outline-none"
          ...
          <SheetContent side="right" className="bg-white z-50">
            ...
            <nav className="flex  flex-col items-center gap-8  lg:space-x-6 text-black z-30">
              <Link
                href="/projects"
                className={`text-base font-bold transition-colors  mx-[12px] my-[15px] ${
                  isActive("/projects")
                    ? "border-b-2 border-[#1e1e24] text-gray-500"
                    : ""
                }`}
              >
                Проекты
        ...
        <nav className="hidden lg:flex items-center gap-8 ms-20 lg:space-x-6 text-black">
          <Link
            href="/projects"
            className={`text-base font-bold transition-colors  mx-[12px] my-[15px] ${
              isActive("/projects")
